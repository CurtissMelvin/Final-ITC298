...
// };
  ...
  module.exports = function(grunt){
    ...
    grunt.initConfig({
      ...
      //nodemon tracks and restart our server for us
      nodemon: {
        dev: {
          script: "index.js"
        }
      ...
      autoprefixer: {
        dev: {
          ...
          flatten: true,
          //uses a globbing pattern instead of reading a single files
          expand: true,
          src: "src/*.css",
          dest: "src/build/css"
        }
    ...
    //by default, regenerates CSS abd then runs our long-lived processes (Hapi server and watch)
